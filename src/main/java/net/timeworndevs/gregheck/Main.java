package net.timeworndevs.gregheck;
...
import net.timeworndevs.gregheck.common.Elements;
import net.timeworndevs.gregheck.common.Materials;
...
public class Main {
    ...
    public static final String MOD_ID = "gregheck";
    public static final Logger LOGGER = LogManager.getLogger();
    public static GTRegistrate EXAMPLE_REGISTRATE = GTRegistrate.create(Main.MOD_ID);
    ...
    private void addMaterialRegistries(MaterialRegistryEvent event) {
        GTCEuAPI.materialManager.createRegistry(Main.MOD_ID);
    }
